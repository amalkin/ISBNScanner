...
// iOS Icons
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-72.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-57.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-57@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-72@2x.png"
        },
// iOS Icons created as of PhoneGap cli 3.3
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-40.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-40@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-50.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-50@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-60.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-60@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-60@3x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-76.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-76@2x.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-small.png"
        },
        {
            "www/res/isbn-scan-icon-57x57.png":
                "platforms/ios/ISBNScan/Resources/icons/icon-small@2x.png"
        },
// iOS Splash
        {
            "www/res/screens/ios/screen-iphone-portrait-2x.png":
                "platforms/ios/ISBNScan/Resources/splash/Default@2x~iphone.png"
        },
        {
            "www/res/screens/ios/screen-iphone-portrait-568h-2x.png":
                "platforms/ios/ISBNScan/Resources/splash/Default-568h@2x~iphone.png"
        },
        {
            "www/res/isbn-scan-icon-144x144.png":
                "platforms/ios/ISBNScan/Resources/splash/Default~iphone.png"
        }
    ],
///////////////////////////
//          ANDROID
